...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
        <img src={assets.bottom_banner_image} alt="bottom_banner_image" className='
        w-full hidden md:block'/>
        <img src={assets.bottom_banner_image_sm} alt="bottom_banner_image_sm" className='
        w-full md:hidden' />
                ...
                <h1 className='text-2xl md:text-3xl font-semibold text-primary md-6'>Why we are the Best ?</h1>
                    {features.map((feature, index)=>(
                        <div key={index} className='flex items-center gap-4 mt-2'>
                            ...
                            <div className=''> {/* A wrapping div for the text content is implied for correct layout */}
