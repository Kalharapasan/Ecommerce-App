...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col item-center md:items-start justify-end
      md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        ...
        max-w-72 md:max-w80 lg:max-w-105 leading-tight lg:leading-15'>Freshness You can Trust, Savings You will Love!</h1>
      ...
      <div className='flex item-center mt-6 font-medium'>
        ...
        <img className='md:hidden translate group-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow icon" /></Link>

        <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3
        cursor-pointer'>
            Explore deals
        <img className=' translate group-hover:translate-x-1' 
        src={assets.black_arrow_icon} alt="arrow icon" /></Link>
